...
public class BinaryTree {
    ...
    void printBreadthFirst() {   printBreadthFirst(root);}
    // Driver method
    public static void main(String[] args)
    {
        ...
        tree.printPreorder();
        System.out.println("\n" + new PreOrderTraversalWithoutRecursion().preorderTraversal(tree.root));

        System.out.println("\nInorder traversal of binary tree is ");
        tree.printInorder();
        System.out.println("\n" + new InOrderTraversalWithoutRecursion().inorderTraversal(tree.root));
